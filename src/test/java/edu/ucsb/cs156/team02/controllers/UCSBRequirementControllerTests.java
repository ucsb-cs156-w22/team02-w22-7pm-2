...
public class UCSBRequirementControllerTests extends ControllerTestCase {
    ...
    @WithMockUser(roles = { "USER" })
    @Test
    public void api_UCSBRequirement__user_logged_in__returns_a_todo_that_exists() throws Exception {
    ...
    @WithMockUser(roles = { "USER" })
    @Test
    public void api_UCSBRequirement__user_logged_in__search_for_todo_that_does_not_exist() throws Exception {
    ...
    @WithMockUser(roles = { "USER" })
    @Test
    public void api_UCSBRequirement__user_logged_in__search_for_todo_that_belongs_to_another_user() throws Exception {
    ...
    @WithMockUser(roles = { "ADMIN" })
    @Test
    public void api_UCSBRequirement__admin_logged_in__search_for_todo_that_belongs_to_another_user() throws Exception {
    ...
    @WithMockUser(roles = { "ADMIN" })
    @Test
    public void api_UCSBRequirement__admin_logged_in__search_for_todo_that_does_not_exist() throws Exception {
    ...
    public void api_UCSBRequirement_admin_all__admin_logged_in__returns_all_UCSBRequirement() throws Exception {
        ...
        ArrayList<Todo> expectedUCSBRequirement = new ArrayList<>();
        expectedUCSBRequirement.addAll(Arrays.asList(todo1, todo2, todo3));

        when(todoRepository.findAll()).thenReturn(expectedUCSBRequirement);
    ...
    public void api_UCSBRequirement_all__user_logged_in__returns_only_UCSBRequirement_for_user() throws Exception {
        ...
        ArrayList<Todo> expectedUCSBRequirement = new ArrayList<>();
        expectedUCSBRequirement.addAll(Arrays.asList(todo1, todo2));
        when(todoRepository.findAllByUserId(thisUser.getId())).thenReturn(expectedUCSBRequirement);
    ...
    @WithMockUser(roles = { "USER" })
    @Test
    public void api_UCSBRequirement__user_logged_in__delete_todo() throws Exception {
        // arrange
    ...
    @WithMockUser(roles = { "USER" })
    @Test
    public void api_UCSBRequirement__user_logged_in__delete_todo_that_does_not_exist() throws Exception {
        // arrange
    ...
    @WithMockUser(roles = { "USER" })
    @Test
    public void api_UCSBRequirement__user_logged_in__cannot_delete_todo_belonging_to_another_user() throws Exception {
        // arrange
    ...
    @WithMockUser(roles = { "ADMIN" })
    @Test
    public void api_UCSBRequirement__admin_logged_in__delete_todo() throws Exception {
        // arrange
    ...
    @WithMockUser(roles = { "ADMIN" })
    @Test
    public void api_UCSBRequirement__admin_logged_in__cannot_delete_todo_that_does_not_exist() throws Exception {
        // arrange
    ...
    @WithMockUser(roles = { "USER" })
    @Test
    public void api_UCSBRequirement__user_logged_in__put_todo() throws Exception {
        // arrange
        ...
        Todo updatedTodo = Todo.builder().title("New Title").details("New Details").done(true).user(otherUser).id(67L)
                .build();
    ...
    @WithMockUser(roles = { "USER" })
    @Test
    public void api_UCSBRequirement__user_logged_in__cannot_put_todo_that_does_not_exist() throws Exception {
        // arrange
    ...
    @WithMockUser(roles = { "USER" })
    @Test
    public void api_UCSBRequirement__user_logged_in__cannot_put_todo_for_another_user() throws Exception {
        // arrange
    ...
    @WithMockUser(roles = { "ADMIN" })
    @Test
    public void api_UCSBRequirement__admin_logged_in__put_todo() throws Exception {
        // arrange
        ...
        Todo updatedTodo = Todo.builder().title("New Title").details("New Details").done(true).user(yetAnotherUser)
                .id(77L)
                .build();
    ...
    @WithMockUser(roles = { "ADMIN" })
    @Test
    public void api_UCSBRequirement__admin_logged_in__cannot_put_todo_that_does_not_exist() throws Exception {
        // arrange
